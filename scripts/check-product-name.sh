...
#   1. scripts/install.sh is fetched standalone and mirrors `name` and
#      `github_repo`; they must match exactly.
...
want_name="$PRODUCT_NAME"; want_repo="$PRODUCT_GITHUB_REPO"
