...
FAILED=0
SCRIPTS=(journey.sh timeline.sh exclusions.sh growth.sh soak.sh crash.sh latency.sh speculation.sh forks.sh forks-scale.sh merge.sh safe-mode.sh mcp-e2e.sh)
